...
```go
const version = "1.0.3"  // Change this to your new version
```
...
- Check that the tag starts with `v` (e.g., `v1.0.3`)

## Complete Example Workflow

```bash
# 1. Update version in code
vim cmd/chief-summarizer/main.go  # Set version = "1.0.3"
...
gh release create v1.0.3 --title "v1.0.3" --notes "Release notes" dist/*
