...
```go
const version = "1.0.1"  // Change this to your new version
```
...
vim cmd/chief-summarizer/main.go  # Set version = "1.0.1"
...
gh release create v1.0.1 --title "v1.0.1" --notes "Release notes" dist/*
