...
3. Choose the tag `v1.1.0` (the one you just pushed)
...
# Output: "New version 1.1.0 is available! (current: 1.0.0)"
#         "Updating binary..."
...
- **Semantic versioning**: Always use proper semver format (v1.0.0, v1.1.0, etc.)
